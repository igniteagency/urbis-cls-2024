...
This GitHub project provides a development workflow for JavaScript files in Urbis CLS 2024.
...
1. The initial `entry.js` file needs to be made available via external server first for this system to work (in the `<head>` area of the site).
   ...
   ```html
   <script src="https://cdn.jsdelivr.net/gh/igniteagency/urbis-cls-2024/dist/prod/entry.js"></script>
   ```
